...
st.write(
    ...
    📂 Please upload the following files:
       ...
       &nbsp;&nbsp;&nbsp;&nbsp; 1️⃣ Sample Data File (`.csv`)

       &nbsp;&nbsp;&nbsp;&nbsp; 2️⃣ Data Contract Configuration (`.yaml`)

    After uploading, you'll see:
    - 📊 A table preview of your sample data
    - 📄 A summary of your data contract configuration
    """
)
...
if sample_data_file_count == 1 and data_contract_configuration_file_count == 1:
    ...
    st.header("📄 Imported Data Contract Configuration")
